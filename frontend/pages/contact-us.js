...
// Custom Data
import { mainEmail } from "../data/email";
              ...
              <div className="col-lg-12">
                ...
                >
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-12">
                      <button className="btn focus-reset" type="submit">
                        Send
                      </button>
                    </div>
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="get-in-touch-single">
                  ...
                  <div className="content">
                    <h4>Help &amp; support</h4>
                    <p>
                      Email <a href={`mailto:${mainEmail}`}>{mainEmail}</a>
                      <br />
                ...
                <div className="get-in-touch-single">
                  ...
                  <div className="content">
                    ...
                    <p>
                      ...
                      <br />
                      <Link to={`mailto:${mainEmail}`}>{mainEmail}</Link>
                    </p>
                  </div>
                </div>
              </div>
